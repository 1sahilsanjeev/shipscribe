...
export function startClaudeCodeWatcher(userId) {
...
function startTailing(userId, filePath) {
...
async function processNewContent(userId, sessionId, isInitial = false) {
...
async function updateSessionState(userId, info) {
...
export async function getCurrentClaudeSession(userId) {
