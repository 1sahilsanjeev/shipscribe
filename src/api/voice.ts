...
router.post('/:id/train', authenticate, async (req: AuthenticatedRequest, res: Response) => {
  const { id } = req.params
  const userId = req.user!.id
...
router.post('/:id/activate', authenticate, async (req: AuthenticatedRequest, res: Response) => {
  const { id } = req.params
  const userId = req.user!.id
...
router.post('/:id/preview', authenticate, async (req: AuthenticatedRequest, res: Response) => {
  const { id } = req.params
  const userId = req.user!.id
